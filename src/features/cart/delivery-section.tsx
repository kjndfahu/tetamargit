				...
				<div className="mt-6 border-t pt-6">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<label className="flex flex-col gap-1">
							...
							<input className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="Ján Novák" />
						</label>
						<label className="flex flex-col gap-1">
							<span className="text-sm text-gray-700 flex items-center gap-2"><Phone className="h-4 w-4 text-[#EE4C7C]" /> Telefón</span>
							<input className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="+421 900 123 456" />
						</label>
						<label className="flex flex-col gap-1 sm:col-span-2">
							<span className="text-sm text-gray-700 flex items-center gap-2"><Mail className="h-4 w-4 text-[#EE4C7C]" /> E‑mail (voliteľné)</span>
							<input className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="jan.novak@example.com" />
						</label>
						<label className="flex flex-col gap-1 sm:col-span-2">
							<span className="text-sm text-gray-700 flex items-center gap-2"><Home className="h-4 w-4 text-[#EE4C7C]" /> Ulica a číslo</span>
							<input className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="Hlavná 12" />
						</label>
						<label className="flex flex-col gap-1">
							<span className="text-sm text-gray-700 flex items-center gap-2"><Building2 className="h-4 w-4 text-[#EE4C7C]" /> Mesto</span>
							<input className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="Bratislava" />
						</label>
						<label className="flex flex-col gap-1">
							<span className="text-sm text-gray-700 flex items-center gap-2"><FileText className="h-4 w-4 text-[#EE4C7C]" /> PSČ</span>
							<input className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="811 01" />
						</label>
						<label className="flex flex-col gap-1 sm:col-span-2">
							...
							<textarea className="border border-gray-300 rounded-lg px-3 py-2 min-h-[88px] focus:outline-none focus:ring-2 focus:ring-[#EE4C7C]" placeholder="Dvere č. 5, zvoniť na Novák"></textarea>
						</label>
					</div>
				</div>
			)}
