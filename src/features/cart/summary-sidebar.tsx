	...
	return (
		<aside className="lg:col-span-1">
			<div className="bg-white shadow rounded-xl p-6">
				<h3 className="text-lg font-semibold text-black mb-4 flex items-center gap-2"><FileText className="h-5 w-5 text-orange-500" /> Spolu</h3>
				...
				<button onClick={onCheckout} className="w-full mt-6 cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2">
