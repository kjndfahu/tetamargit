		...
		<section className="bg-white shadow rounded-xl p-6">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<button
					...
					className={`${paymentMethod === "card" ? "border-orange-500 ring-2 ring-orange-200" : "border-gray-200"} cursor-pointer rounded-lg border p-4 text-left transition focus:outline-none`}
				>
				...
				<button
					...
					className={`${paymentMethod === "cash" ? "border-orange-500 ring-2 ring-orange-200" : "border-gray-200"} cursor-pointer rounded-lg border p-4 text-left transition focus:outline-none`}
				>
					<div className="flex items-center justify-between">
